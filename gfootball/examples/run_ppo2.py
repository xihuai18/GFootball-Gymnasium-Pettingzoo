...
flags.DEFINE_enum(
    "state", "extracted_stacked", ["extracted", "extracted_stacked"], "Observation to be used for training."
)
...
def train(_):
    ...
    vec_env = SubprocVecEnv(
        [(lambda _i=i: create_single_football_env(_i)) for i in range(FLAGS.num_envs)], context=None
    )
