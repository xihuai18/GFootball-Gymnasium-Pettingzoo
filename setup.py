...
class CustomBuild(build_ext):
    ...
    def run_unix(self):
        ...
        try:
            ...
            raise ValueError(
                "Could not parse GFOOTBALL_USE_PREBUILT_SO environment " "variable as int. Please set it to 0 or 1"
            )

        if use_prebuilt_lib:
            if os.system(
                "cp third_party/gfootball_engine/lib/prebuilt_gameplayfootball.so " + dest_dir + "/_gameplayfootball.so"
            ):
...
setup(
    ...
    long_description=("Please see [our GitHub page](https://github.com/google-research/football) " "for details."),
    ...
    install_requires=["pygame>=1.9.6", "opencv-python", "psutil", "numpy", "gymnasium", "absl-py", "wheel", "six"],
