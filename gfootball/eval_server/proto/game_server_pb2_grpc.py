...
from gfootball.eval_server.proto import (
    game_server_pb2 as gfootball_dot_eval__server_dot_proto_dot_game__server__pb2,
)
...
def add_GameServerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("gfootball.eval_server.GameServer", rpc_method_handlers)
